...
class MapGrid():
    ...
    def __init__(self, coordinates_tl, coordinates_dr, grid_rows=10, grid_columns=10):
        ...
        self.latitude_pass = latitude_distance / grid_rows
        self.latitude_init = coordinates_tl[0]

        longitude_distance = coordinates_dr[1] - coordinates_tl[1]
        self.longitude_pass = longitude_distance / grid_columns
